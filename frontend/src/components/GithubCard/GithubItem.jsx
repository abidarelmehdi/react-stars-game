          ...
          <div className="flex px-4 py-4 sm:px-6">
            ...
            <div className="flex-auto">
              <div className="flex items-center justify-between">
                <span className="text-lg leading-5 font-medium text-indigo-600 truncate">
                  {this.props.name}
                </span>
                <div className="ml-2 flex-shrink-0 flex">
                  <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                    {this.props.public_repos} Public repos
                  </span>
                </div>
              </div>
              <div className="mt-2 sm:flex sm:justify-between">
                <div className="sm:flex">
                  ...
                  <a
                    ...
                    target="_blank"
                    className="mt-2 flex items-center text-sm leading-5 text-blue-500 sm:mt-0"
                  >
                    <svg
                      className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400"
                      fill="currentColor"
                ...
                <div className="mt-2 flex items-center text-sm leading-5 text-gray-500 sm:mt-0">
                  ...
                  <span>
                    ...
                    <time dateTime={this.props.created_at}>
